...
const task1Quiz: QuizQuestion[] = [
  ...
  },
  {
    id: "m1t1-q5",
    type: "multiple_choice",
    prompt: "In the standard disassembly order, which of these is removed FIRST, right after the side cover?",
    options: [
      { id: "a", text: "The power supply unit" },
      { id: "b", text: "The motherboard" },
      { id: "c", text: "The RAM" },
      { id: "d", text: "The optical drive" },
    ],
    correctOptionIds: ["a"],
    explanation: "The task sheet's order is: side cover, then power supply unit, then hard drive, then optical drive, then RAM, then motherboard last.",
  },
  {
    id: "m1t1-q6",
    type: "multiple_choice",
